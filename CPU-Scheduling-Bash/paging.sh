#!/bin/bash
#TOS2111 – Operating Systems I"
#STUDENT ID:1101110321 STUDENT NAME: EMMANUEL ELIASON-ARMSTRONG"
#STUDENT ID:1111113245 STUDENT NAME:Mohamed Saleh"
...
########################################################################################
    ...
    #END OF OPTIMAL FUNCTION
    
	echo " "
    #menu function
    #run the loop until the user choose 4 to exit the program
    while [[ $ch -ne 4 ]]
    do
    echo " "
    echo " TOS2111 – Operating Systems I"
    echo " STUDENT ID:1101110321 STUDENT NAME :EMMANUEL ELIASON-ARMSTRONG"
   	echo " STUDENT ID:1111113254 STUDENT NAME :Mohamed Saleh"
    echo " "
    echo " Assignment :Paging Algorithm Simulation" 
	echo " pLease choose 1 for FIFO ,2 for LRU,3 for lFU and 4 to exit the program"     
    echo " Menu:"
    echo " 1:FIFO"
    echo " 2:LRU"
    echo " 3:LFU"
